  ...
  class SettingsScreenState extends State<SettingsScreen> {
    ...
    final FirebaseAnalytics _analytics = FirebaseAnalytics.instance; // Firebase Analytics örneği
    ...
    Future<void> _saveSettingsAndExit() async {
      ...
      // Firebase Analytics'e ayarları kaydet
      try {
        await _analytics.logEvent(
          ...
          parameters: {
            ...
            'show_jokers': _showJokers.toString(), // `bool` -> `String`
